...
class DayCell extends StatelessWidget {
  ...
  const DayCell({super.key, this.day, this.onTap, this.isToday = false});
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            if (hasPlan) Expanded(child: _buildPlanInfo(context)),
          ],
        ),
      ),
    );
  ...
  Widget _buildPlanInfo(BuildContext context) {
    ...
    final visibleMeals =
        meals.length >= 4 ? meals.take(2).toList() : meals.take(3).toList();
