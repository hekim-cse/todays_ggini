    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          GestureDetector(
            ...
            child: Row(
              ...
              children: [
                ...
                Text('이전', style: Theme.of(context).textTheme.bodySmall),
              ],
            ),
          ),
          ...
          Text('[다양성]', style: Theme.of(context).textTheme.bodyLarge),
          ...
          Text('[요리 실력]', style: Theme.of(context).textTheme.bodyLarge),
          const SizedBox(height: 8),
          LabeledSlider(
          ...
          Text('[식사 수]', style: Theme.of(context).textTheme.bodyLarge),
          const SizedBox(height: 8),
          LabeledSlider(
          ...
          Text('[한달 식비 예산]', style: Theme.of(context).textTheme.bodyLarge),
          const SizedBox(height: 8),
          BudgetSlider(
