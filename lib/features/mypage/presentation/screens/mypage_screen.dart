...
class _MyPageScreenState extends State<MyPageScreen> {
  ...
  void _showSliderDialog(
    ...
    showAppPopupWidget(
      context: context,
      title: '[$title]',
      contentWidget: _buildSliderContent(
        context,
        value,
        min,
        max,
  ...
  void _showAllergyDialog() {
    showAppPopupWidget(
      context: context,
      title: '[제외 재료]',
      contentWidget: _buildChipRow(context, _allergies, _allergies),
      leftButtonText: '재설정하기',
      rightButtonText: '확인',
      leftButtonColor: AppColors.primary,
      rightButtonColor: AppColors.textSecondary,
          ...
          child: Column(
            children: [
              ...
              SettingItem(
                ...
                value: '$_diversity단계',
                onTap:
                    () => _showSliderDialog('다양성', _diversity, 1, 3, (v) {
              ...
              SettingItem(
                ...
                onTap:
                    () => _showSliderDialog('요리 실력', _cookingSkill, 1, 5, (v) {
                      switch (v) {
                        case 1:
                          return '라면도 태워요';
                        case 2:
